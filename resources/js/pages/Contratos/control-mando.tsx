                                    ...
                                    <td className="px-2 py-2">
                                            <div className="flex flex-col gap-1 items-center">
                                                {!contrato.formalizado && (
                                                    <Link href={`/contratos/formalizar/${contrato.id}`} className="w-full min-w-37.5 bg-[#4fc3f7] hover:bg-blue-400 text-white text-[9px] py-0.5 text-center font-bold rounded shadow-sm"
                                                    method='put'>
                                                        COMPLETAR CONTRATO
                                                    </Link>)}
