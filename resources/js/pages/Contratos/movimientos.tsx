        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="bg-[#e96b7d] p-2 px-4 text-white font-bold text-lg shadow-sm uppercase flex justify-between items-center tracking-tight">
                ...
                <div className="flex items-center gap-2">
                    <span className="text-[9px] bg-black/20 px-2 py-0.5 rounded border border-white/20">SISTEMA_AUDITORIA_V3</span>
                </div>
            </div>
                        ...
                        <table className="w-full border-collapse text-[11px] uppercase">
                            <thead>
                                <tr className="bg-gray-100 border-b border-gray-300">
                                    <th className="px-4 py-2 text-left font-bold text-gray-700 border-r border-gray-200 w-40">Marca de Tiempo</th>
                                    ...
                                    <th className="px-4 py-2 text-left font-bold text-gray-700 w-48">Agente Responsable</th>
                                </tr>
                            </thead>
